###########################################################################
## Makefile generated for Simulink model 'pendu_vesc_modified'. 
## 
## Makefile     : pendu_vesc_modified.mk
## Generated on : Mon Jun 22 13:01:20 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pendu_vesc_modified.elf
...
PRODUCT_NAME              = pendu_vesc_modified
MAKEFILE                  = pendu_vesc_modified.mk
COMPUTER                  = GLNX
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = $(MATLAB_WORKSPACE)/D/Ben/pilcoV0.9/control
ARCH                      = glnx
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pendu_vesc_modified.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/pendu_vesc_modified_ert_rtw -I$(MATLAB_WORKSPACE)/D/Ben/pilcoV0.9/scenarios/pendubot -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_WORKSPACE)/D/TANGYunxi/cm_custom/src -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2018b/toolbox/realtime/targets/raspi/include -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2018b/toolbox/realtime/targets/raspi/server -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=pendu_vesc_modified -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = pendu_vesc_modified.cpp.o pendu_vesc_modified_data.cpp.o rtGetInf.cpp.o rtGetNaN.cpp.o rt_nonfinite.cpp.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o sf_vesc_usb_wrapper.cpp.o MW_raspi_init.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o linuxinitialize.cpp.o
...
%.c.o : $(START_DIR)/pendu_vesc_modified_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/pendu_vesc_modified_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/pendu_vesc_modified_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
