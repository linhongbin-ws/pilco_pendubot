...
//
// File: pendu_vesc_modified_private.h
//
...
//
#ifndef RTW_HEADER_pendu_vesc_modified_private_h_
#define RTW_HEADER_pendu_vesc_modified_private_h_
#include "rtwtypes.h"
...
int_T rt_WriteMat4FileHeader(FILE *fp,
  ...
  int32_T n,
  const char_T *name);
extern void pendu_vesc_mo_IfActionSubsystem(real_T rtu_In1, real_T *rty_Out1,
  P_IfActionSubsystem_pendu_ves_T *localP);
extern void pendu_vesc_modif_MATLABFunction(real_T rtu_u, real_T *rty_y);

#endif                                 // RTW_HEADER_pendu_vesc_modified_private_h_ 
