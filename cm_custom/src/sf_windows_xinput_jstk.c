 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Dec 13 10:06:51 2018
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sf_windows_xinput_jstk
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            2
/* Input Port  0 */
#define IN_PORT_0_NAME        wLeftMotorSpeed
...
/* Input Port  1 */
#define IN_PORT_1_NAME        wRightMotorSpeed
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       wButtons
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       bLeftTrigger
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       bRightTrigger
...
/* Output Port  3 */
#define OUT_PORT_3_NAME       sThumbLX
...
/* Output Port  4 */
#define OUT_PORT_4_NAME       sThumbLY
...
/* Output Port  5 */
#define OUT_PORT_5_NAME       sThumbRX
...
/* Output Port  6 */
#define OUT_PORT_6_NAME       sThumbRY
...
/* Output Port  7 */
#define OUT_PORT_7_NAME       jstkConnected
...
#define NPARAMS               1
/* Parameter 0 */
#define PARAMETER_0_NAME      jstkID
...
extern void sf_windows_xinput_jstk_Start_wrapper(const uint8_T *jstkID, const int_T p_width0);
extern void sf_windows_xinput_jstk_Outputs_wrapper(const real32_T *wLeftMotorSpeed,
...
static void mdlStart(SimStruct *S)
{
    ...
    const uint8_T *jstkID = (const uint8_T *) mxGetData(PARAM_DEF0(S));
    
    sf_windows_xinput_jstk_Start_wrapper(jstkID, p_width0);
}
#endif /*  MDL_START */
...
{
    const real32_T *wLeftMotorSpeed = (real32_T *) ssGetInputPortRealSignal(S, 0);
    const real32_T *wRightMotorSpeed = (real32_T *) ssGetInputPortRealSignal(S, 1);
    uint16_T *wButtons = (uint16_T *) ssGetOutputPortRealSignal(S, 0);
    real32_T *bLeftTrigger = (real32_T *) ssGetOutputPortRealSignal(S, 1);
    real32_T *bRightTrigger = (real32_T *) ssGetOutputPortRealSignal(S, 2);
    real32_T *sThumbLX = (real32_T *) ssGetOutputPortRealSignal(S, 3);
    real32_T *sThumbLY = (real32_T *) ssGetOutputPortRealSignal(S, 4);
    real32_T *sThumbRX = (real32_T *) ssGetOutputPortRealSignal(S, 5);
    real32_T *sThumbRY = (real32_T *) ssGetOutputPortRealSignal(S, 6);
    boolean_T *jstkConnected = (boolean_T *) ssGetOutputPortRealSignal(S, 7);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const uint8_T *jstkID = (const uint8_T *) mxGetData(PARAM_DEF0(S));
    
    sf_windows_xinput_jstk_Outputs_wrapper(wLeftMotorSpeed, wRightMotorSpeed, wButtons, bLeftTrigger, bRightTrigger, sThumbLX, sThumbLY, sThumbRX, sThumbRY, jstkConnected, jstkID, p_width0);
